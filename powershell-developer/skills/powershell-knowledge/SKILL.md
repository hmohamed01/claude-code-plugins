---
name: powershell-knowledge
description: >
  Comprehensive PowerShell development knowledge for scripts, modules, GUIs, and Windows automation.
  Use when working with: (1) PowerShell script development and best practices, (2) Function and parameter design,
  (3) Pipeline handling and error management, (4) Windows Forms and WPF GUI creation,
  (5) PowerShell Gallery module management, (6) PSScriptAnalyzer and code quality.
---
...
1. **For module verification**: Execute `Search-Gallery.ps1` from this skill:
   ```powershell
   $CLAUDE_PLUGIN_ROOT/skills/powershell-knowledge/scripts/Search-Gallery.ps1 -Name 'ModuleName'
   ```
